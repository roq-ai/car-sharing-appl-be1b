...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'car-owner', 'customer-service-representative', 'end-customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Cars', path: '/cars', entity: 'car', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Issues', path: '/issues', entity: 'issue', service: AccessServiceEnum.PROJECT, icon: FiAlertCircle },
    { name: 'Reviews', path: '/reviews', entity: 'review', service: AccessServiceEnum.PROJECT, icon: FiStar },
